...
def add_contact():
    if os.path.isfile('phonebook_file.pickle') == True:
        phonebook3 = open('phonebook_file.pickle','r+')
        list_contacts = pickle.load(phonebook3)
    #is_file_empty = os.path.getsize('address_book_file.pickle') == 0
    ...
    try:
        ...
        phonebook3 = open('phonebook_file', 'w+')
        list_contacts.append(contact)
        pickle.dump(list_contacts, phonebook3)
        print '%s contact added' % contact
...
while True:
    print_menu()
    menu_choice = int(raw_input('What do you want to do? (1-6): '))
